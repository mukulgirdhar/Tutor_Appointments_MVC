...
namespace Tutor_Appointments_MVC.Controllers
{
    ...
    public class FacultiesController : Controller
    {
        ...
        public FacultiesController(Tutor_Appointments_DBContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Email")] Faculty faculty)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Email")] Faculty faculty)
        {
            if (id != faculty.Id)
            {
                return NotFound();
